...
export const MEMBER_TIERS: MemberTier[] = [
  ...
  },
  {
    ...
    color: "#d4af37", bonusCredits: 2500, discount: 0.25, vipSessions: 9999,
    perks: ["2,500 bonus credits/month", "25% off credit purchases", "Unlimited VIP access"],
  ...
  },
  {
    ...
    color: "#38bdf8", bonusCredits: 5000, discount: 0.25, vipSessions: 9999,
    perks: ["5,000 bonus credits/month", "25% off credit purchases", "Diamond concierge service"],
    features: ["Everything in Black Card", "5,000 bonus credits/month", "25% discount on credit purchases", "Unlimited VIP Lounge access", "Diamond concierge service", "Quarterly gifting package", "Private creator events"],
    notIncluded: [],
    cta: "Get Diamond", popular: false,
  },
  {
    id: "obsidian", name: "Obsidian", emoji: "🔮", price: 299.99, priceStr: "$299.99",
    color: "#8b5cf6", bonusCredits: 15000, discount: 0.25, vipSessions: 9999,
    perks: ["15,000 bonus credits/month", "25% off credit purchases", "Priority platform access"],
    features: ["Everything in Diamond", "15,000 bonus credits/month", "25% discount on credit purchases", "Unlimited VIP Lounge access", "Obsidian elite badge", "Monthly curated creator package", "Priority platform access"],
    notIncluded: [],
  ...
  },
  {
    ...
    perks: ["50,000 bonus credits/month", "25% off + white-glove service", "Bi-weekly strategy sessions"],
    features: ["Everything in Obsidian", "50,000 bonus credits/month", "25% discount on credit purchases", "Unlimited VIP Lounge access", "Platinum crown profile frame", "Bi-weekly strategy sessions", "White-glove personal manager"],
    notIncluded: [],
