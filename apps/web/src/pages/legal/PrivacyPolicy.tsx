    ...
    <div className="min-h-screen bg-background py-10 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="p-4 rounded-xl border border-primary/30 bg-primary/5 mb-6">
          ...
          <p className="text-muted-foreground text-xs mt-1">CRAVR is committed to protecting your privacy. We handle adult content and interactions with the highest discretion. Your billing statement will show a neutral merchant name — never "CRAVR."</p>
        </div>
        ...
        <div className="space-y-4 text-sm text-muted-foreground leading-relaxed">
          {[
            ...
            },
            {
              ...
              content: `We understand the sensitive nature of adult platform billing. All charges will appear on your bank or credit card statement as "CCBILL*CRAVR" or a similar neutral descriptor. We never use "adult," "dating," or explicit language in billing descriptors.\n\nFor maximum discretion, we recommend using a prepaid card or virtual card number available from most banks.`,
            },
            {
