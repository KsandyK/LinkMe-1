        ...
        <div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
          ...
          <div className="p-5 rounded-xl border" style={{ background: "rgba(20,184,166,0.04)", borderColor: "rgba(20,184,166,0.25)" }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
              {[
                { dept: "💬 General Support",  email: "support@cravr.fun",  desc: "Billing, account issues, safety reports, appeals" },
                { dept: "🎬 Creator Support",  email: "creators@cravr.fun", desc: "Payouts, verification, content disputes, studio help" },
                { dept: "⚖️ Legal & Compliance", email: "legal@cravr.fun",   desc: "DMCA, law enforcement, GDPR, §2257, privacy requests" },
              ].map(c => (
...
2.4 You acknowledge that CRAVR employs technical, procedural, and contractual measures to prevent minor access, and that your affirmative representation of age is the foundational layer of this system. Providing false age information is a material breach of these Terms.`,
            },
            {
              ...
              content: `3.1 CRAVR is a premium hybrid adult dating and live interaction platform providing:
...
4.5 Chargebacks & Disputes: Initiating a chargeback or payment dispute without first exhausting CRAVR's internal dispute resolution process (support@cravr.fun) constitutes a breach of these Terms. In such cases:
...
5.2 Enforcement: Violations may result in: content removal, account suspension, permanent ban, forfeiture of credits without refund, and/or referral to law enforcement. CRAVR is the sole arbiter of violations and its decisions are final.`,
            },
            {
...
6.4 DMCA: If you believe content infringes your copyright, send a DMCA notice to: legal@cravr.fun. Repeat infringers' accounts will be terminated.
...
Billing Discretion: All charges appear as "CCBILL*CRAVR" or similar neutral descriptor on your bank statement. We never use explicit descriptors in billing.`,
            },
            {
              title: "8. DISCLAIMER OF WARRANTIES",
              content: `TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW:

THE SERVICE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE. CRAVR EXPRESSLY DISCLAIMS ALL WARRANTIES INCLUDING:
...
YOUR USE OF THE SERVICE IS ENTIRELY AT YOUR OWN RISK.`,
            },
            {
              ...
              content: `9.1 LIMITATION: TO THE MAXIMUM EXTENT PERMITTED BY LAW, CRAVR, ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AND LICENSORS SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, PUNITIVE, OR EXEMPLARY DAMAGES, INCLUDING LOSS OF PROFITS, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
...
11.2 CRAVR complies with applicable anti-money laundering (AML) regulations. We reserve the right to report suspicious financial activity to relevant authorities and to freeze accounts under investigation.
...
11.3 You agree to comply with all applicable local, state, national, and international laws in connection with your use of the Service.`,
            },
            {
              ...
              content: `12.1 CRAVR may suspend or terminate your account at any time, with or without notice, for any violation of these Terms. Suspension does not entitle you to a refund of credits or fees.
...
12.3 Force Majeure: CRAVR shall not be liable for any failure or delay in performance resulting from causes beyond its reasonable control, including natural disasters, war, terrorism, government actions, pandemics, internet outages, or cyberattacks.
...
13.3 Entire Agreement: These Terms, the Privacy Policy, and Code of Conduct constitute the entire agreement between you and CRAVR regarding the Service and supersede all prior agreements.
...
Creator Support (payouts, verification):     creators@cravr.fun
Legal & Compliance (DMCA, GDPR, LE):        legal@cravr.fun`,
            },
            {
...
Incomplete notices will not be actioned. CRAVR will respond to valid notices within 3–5 business days.
...
CRAVR maintains a strict repeat-infringer policy in accordance with 17 U.S.C. § 512(i). Accounts that accumulate two or more substantiated DMCA complaints will be permanently terminated without refund of credits or fees. Terminated accounts may not re-register.

14.5 Misuse & Abuse of Process
Filing a knowingly false DMCA takedown notice constitutes perjury and may expose you to civil liability under 17 U.S.C. § 512(f), including damages, costs, and attorney's fees incurred by the alleged infringer, the account holder, and CRAVR. We actively investigate and report bad-faith notice filers to appropriate authorities.

14.6 Safe Harbour Statement
CRAVR operates as a service provider within the meaning of 17 U.S.C. § 512 and qualifies for the DMCA safe harbour. We act expeditiously to remove or disable access to infringing material upon receipt of a valid notice and do not have actual knowledge of infringing activity unless specifically notified through the procedure above.
...
For content that violates our policies (harassment, illegal material, community standards violations) but does not constitute copyright infringement, please use:
  support@cravr.fun — urgent safety or abuse reports
  support@cravr.fun — general policy violations
  legal@cravr.fun — official law enforcement requests only`,
            },
          ].map(section => (
