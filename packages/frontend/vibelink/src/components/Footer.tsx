      ...
      <div className="container py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-3">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center text-sm" style={{ background: "linear-gradient(135deg, #14b8a6, #0d9488)" }}>ðŸ’Ž</div>
              <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem", fontWeight: 700, color: "white" }}>LINKME</span>
            </div>
            ...
            <div className="flex items-center gap-2 mt-3">
              ...
              <div className="px-2 py-1 rounded text-xs font-bold" style={{ background: "rgba(20,184,166,0.1)", border: "1px solid rgba(20,184,166,0.2)", color: "#5eead4" }}>ðŸ”’ SSL</div>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                ...
                { href: "/legal/2257", label: "18 U.S.C. Â§ 2257" },
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.2)" }}>
            Â© {new Date().getFullYear()} LINKME. All rights reserved. For adults 18+ only.
          </p>
          <div className="flex items-center gap-4">
            <span className="text-xs" style={{ color: "rgba(255,255,255,0.2)" }}>ðŸ”’ Secure & Encrypted</span>
            <span className="text-xs" style={{ color: "rgba(255,255,255,0.2)" }}>ðŸ›¡ï¸ Privacy Protected</span>
