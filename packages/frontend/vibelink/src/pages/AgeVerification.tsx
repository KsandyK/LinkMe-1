/**
 * VIBELINK â€” Age Verification Page
...
const VERIFY_BG = "https://d2xsxph8kpxj0f.cloudfront.net/310519663496736475/iocsuczeEqfyUdtEzAFeTS/vibelink-verify-bg-c43C2oaUJmVUL7HgU3tmc7.webp";
...
export default function AgeVerification() {
  ...
  const validateDob = () => {
    ...
    if (m < 1 || m > 12) { setDobError("Please enter a valid month (1â€“12)."); return false; }
    if (d < 1 || d > 31) { setDobError("Please enter a valid day (1â€“31)."); return false; }
        ...
        {step === "intro" && (
          <div className="vl-card p-6 animate-fade-up">
            ...
            <div className="space-y-3 mb-6">
              {[
                { icon: "ðŸ”’", title: "End-to-End Encrypted", desc: "Your ID documents are encrypted immediately upon upload and deleted after verification." },
                { icon: "ðŸ›¡ï¸", title: "Privacy Protected", desc: "We collect only the minimum data required for age verification. No marketing use." },
                { icon: "âš¡", title: "Fast Process", desc: "Verification typically completes within 2â€“5 minutes." },
                { icon: "âœ“", title: "One-Time Only", desc: "You only need to verify once. Your verified status persists across sessions." },
              ].map(item => (
            ...
            <div className="mb-5">
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  { value: "drivers-license", label: "Driver's License", icon: "ðŸªª" },
                  { value: "national-id", label: "National ID", icon: "ðŸ†”" },
                ].map(t => (
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <ul className="text-xs space-y-1" style={{ color: "rgba(255,255,255,0.45)" }}>
                    <li>â€¢ Documents are encrypted with AES-256 before transmission</li>
                    <li>â€¢ Raw images are permanently deleted after verification (within 24 hours)</li>
                    <li>â€¢ Only your age confirmation result is stored â€” not your ID details</li>
                    <li>â€¢ Compliant with GDPR Article 9 (biometric/identity data)</li>
                    <li>â€¢ We never sell or share your identity documents</li>
                  </ul>
                </div>
              </div>
            </div>
                ...
                >
                  {idUploaded ? (
                    ...
                    <>
                      ...
                      <span className="text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>JPG, PNG, or PDF â€” Max 10MB</span>
                    </>
                  )}
                </button>
              </div>
        ...
        {step === "complete" && (
          <div className="vl-card p-8 text-center animate-scale-in">
            ...
            <div className="vl-success-box mb-6 text-left">
              ...
              <ul className="text-xs space-y-1" style={{ color: "rgba(255,255,255,0.45)" }}>
                <li>âœ“ Your ID documents have been scheduled for deletion within 24 hours</li>
                <li>âœ“ Only your verified age status is retained in our system</li>
                <li>âœ“ You will not need to re-verify unless required by law</li>
              </ul>
            </div>
